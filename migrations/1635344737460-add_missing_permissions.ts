...
export class addMissingPermissions1635344737460 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('INSERT INTO `permissions` (uuid, name) VALUES ("8f3d28cd-f17d-423b-8e4d-20143246ccf7", "component:filesafe")')
    await queryRunner.query('INSERT INTO `permissions` (uuid, name) VALUES ("14283420-6d22-43e6-a63b-26e755604dc6", "component:folders")')
    await queryRunner.query('INSERT INTO `permissions` (uuid, name) VALUES ("3d362e65-1874-4bcd-ba37-1918aa71f5f6", "theme:no-distraction")')
    await queryRunner.query('INSERT INTO `permissions` (uuid, name) VALUES ("53812c9b-9c3d-4c3f-927b-5e1479e1e3a0", "theme:dynamic")')
