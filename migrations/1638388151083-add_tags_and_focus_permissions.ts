...
export class addTagsAndFocusPermissions1638388151083 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('DELETE FROM `role_permissions` WHERE role_uuid = "bde42e26-628c-44e6-9d76-21b08954b0bf" AND permission_uuid = "3f7044d6-c74d-48c2-8b5d-ef69e8b3d922"')
  }
