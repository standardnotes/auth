...
export class addRevokedSessions1610015065194 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.query('CREATE TABLE IF NOT EXISTS `revoked_sessions` (`uuid` varchar(36) NOT NULL, `user_uuid` varchar(36) NOT NULL, `created_at` datetime NOT NULL, INDEX `index_revoked_sessions_on_user_uuid` (`user_uuid`), PRIMARY KEY (`uuid`)) ENGINE=InnoDB')
    }
