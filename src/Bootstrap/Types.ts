const TYPES = {
  ...
  DashboardTokenRepository: Symbol.for('DashboardTokenRepository'),
  // Middleware
  ...
  CreateDashboardToken: Symbol.for('CreateDashboardToken'),
  AuthenticateDashboardToken: Symbol.for('AuthenticateDashboardToken'),
  // Handlers
